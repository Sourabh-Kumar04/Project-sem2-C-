...
int main () {
    ...
    ofstream file;
    file.open("student.txt", ios::out);   // ios::out is used to open the file in read mode
    for (int i = 0; i < 5; i++) {
    ...
    ifstream file2;
    file2.open("students.txt", ios::in);  // ios::in is used to open the files i read mode
    for ( int i=0; i < 5; i++) {
